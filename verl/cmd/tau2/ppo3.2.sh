...
export AREW_BONUS_SCALE="${AREW_BONUS_SCALE:-5.0}"
export AREW_NEGATIVE_STEP_MODE="${AREW_NEGATIVE_STEP_MODE:-full}"
export AREW_START_STEP="${AREW_START_STEP:-0}"
export AREW_END_STEP="${AREW_END_STEP:--1}"

project_name="${DATA_NAME}-${DOMAIN_NAME}-Train"
experiment_name="solo-step_abs_sum-arew-5.0-14B-think-full-neg"
